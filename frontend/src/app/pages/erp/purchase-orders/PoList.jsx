...
export default function PoList() {
  ...
  const statusBody = (row) => {
    const severityMap = { draft: "info", confirmed: "warning", in_progress: "primary", received: "success", cancelled: "danger" };
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-3 flex flex-wrap gap-3 items-center">
        ...
        <InputText placeholder="Search by PO#, vendor..."
      ...
      <DataTable value={orders} loading={loading}
        ...
        <Column field="expected_delivery" header="Expected Delivery" style={{ width: "120px" }} />
